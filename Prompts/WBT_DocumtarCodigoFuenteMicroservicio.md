...
Tu misión es generar un archivo completo llamado `SemanticDocumentation.md` para el sistema VAC, tomando el código fuente .NET como verdad técnica principal y garantizando cobertura total, precisión semántica y cero omisiones de secciones o endpoints.
...
2. `docs/VAC 2.postman_collection.json` (contraste de contratos y ejemplos).
